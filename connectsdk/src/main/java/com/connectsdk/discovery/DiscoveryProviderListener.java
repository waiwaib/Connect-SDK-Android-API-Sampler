...
/**
 * The DiscoveryProviderListener is mechanism for passing service information to the DiscoveryManager.
 * You likely will not be using the DiscoveryProviderListener class directly, as DiscoveryManager
 * acts as a listener to all of the DiscoveryProviders.
 */
public interface DiscoveryProviderListener {

    /**
     * This method is called when the DiscoveryProvider discovers a service that matches one of
     * its DeviceService filters. The ServiceDescription is created and passed to the listener
     * (which should be the DiscoveryManager). The ServiceDescription is used to create a DeviceService, which is then attached to a ConnectableDevice object.
     *
    ...
    /**
     * This method is called when the DiscoveryProvider's internal mechanism loses reference
     * to a service that matches one of its DeviceService filters.
     *
