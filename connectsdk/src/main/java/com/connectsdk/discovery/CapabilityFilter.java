...
/**
 * CapabilityFilter is an object that wraps a List of required capabilities.
 * This CapabilityFilter is used for determining which devices will appear in
 * DiscoveryManager's compatibleDevices array. The contents of a CapabilityFilter's array
 * must be any of the string constants defined in the Capability Class constants.
 * <p>
 ...
 * <p>
 * All Capability header files also define a constant array of all capabilities defined
 * in that header (ex. kVolumeControlCapabilities).
 * <p>
 * ###AND/OR Filtering
 * <p>
 * CapabilityFilter is an AND filter. A ConnectableDevice would need to satisfy all conditions
 * of a CapabilityFilter to pass.
 * <p>
 * The DiscoveryManager capabilityFilters is an OR filter. a ConnectableDevice only needs to
 * satisfy one condition (CapabilityFilter) to pass.
 * <p>
 * ###Examples
 * <p>
 ...
 * <p>
 * new CapabilityFilter(MediaPlayer.Display_Video,MediaControl.Any,VolumeControl.Volume_Up_Down);
 * <p>
...
public class CapabilityFilter {
    ...
    /**
     * List of capabilities required by this filter. This property is readonly
     * -- use the addCapability or addCapabilities to build this object.
     */
     ...
     *                     (see capability class files for String constants)
     */
     ...
     *
     * @param capability Capability name to add
     *                   (see capability class files for String constants)
     */
    ...
    /**
     * Add array of required capabilities to the filter.
     * (see capability classes files for String constants)
     *
