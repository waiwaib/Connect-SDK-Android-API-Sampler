...
public class ExternalInputInfo implements JSONSerializable {
     ...
     */
    @Override
    public boolean equals(Object externalInputInfo) {
        if (externalInputInfo instanceof ExternalInputInfo) {
            ExternalInputInfo eii = (ExternalInputInfo) externalInputInfo;
