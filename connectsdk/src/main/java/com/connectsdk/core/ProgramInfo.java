...
public class ProgramInfo {
     ...
     */
    @Override
    public boolean equals(Object programInfo) {
        if (programInfo instanceof ProgramInfo) {
            ProgramInfo pi = (ProgramInfo) programInfo;
            return id.equals(pi.id) && name.equals(pi.name);
        }
        return super.equals(programInfo);
    }
}