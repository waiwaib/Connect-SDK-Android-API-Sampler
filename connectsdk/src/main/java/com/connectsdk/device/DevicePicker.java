 ...
 * ###Overview
 * <p>
 * The DevicePicker is provided by the DiscoveryManager as a simple way for you to present a list
 * of available devices to your users.
 * <p>
 * ###In Depth
 * <p>
 * By calling the getPickerDialog you will get a reference to the AlertDialog that will be updated
 * automatically updated as compatible devices are discovered.
 * @noinspection unused
 */
public class DevicePicker {
    ...
    /**
     * This method will return an AlertDialog that contains a ListView with an item for
     * each discovered ConnectableDevice.
     *
    ...
    public AlertDialog getPickerDialog(String message, final OnItemClickListener listener) {
        final DevicePickerListView rootView = new DevicePickerListView(activity);
