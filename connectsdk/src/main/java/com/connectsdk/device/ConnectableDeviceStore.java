...
/**
 * ConnectableDeviceStore is a interface which can be implemented to save key information
 * about ConnectableDevices that have been connected to.  Any class which implements
 * this interface can be used as DiscoveryManager's deviceStore.
 * <p>
 * A default implementation, DefaultConnectableDeviceStore, will be used by DiscoveryManager
 * if no other ConnectableDeviceStore is provided to DiscoveryManager when startDiscovery is called.
 * <p>
 * ###Privacy Considerations
 * <p>
 * If you chose to implement ConnectableDeviceStore,
 * it is important to keep your users' privacy in mind.
 * <p>
...
public interface ConnectableDeviceStore {
    ...
    /**
     * Add a ConnectableDevice to the ConnectableDeviceStore.
     * If the ConnectableDevice is already stored, it's record will be updated.
     *
     ...
     * To gt a strongly-typed ConnectableDevice object, use the `getDevice(String);` method.
     */
    JSONObject getStoredDevices();

    /**
     * Gets a ConnectableDevice object for a provided id.
     * The id may be for the ConnectableDevice object or any of the DeviceServices.
     *
     * @param uuid Unique ID for a ConnectableDevice or any of its DeviceService objects
     * @return ConnectableDevice object if a matching uuid was found, otherwise will return null
     */
    ConnectableDevice getDevice(String uuid);

    /**
     * Gets a ServiceConfig object for a provided UUID.
     * This is used by DiscoveryManager to retain crucial service information
     * between sessions (pairing code, etc).
     *
