 ...
 * ###Overview
 * <p>
 * When a web app is launched on a first screen device, there are
 ...
 * <p>
 * ###In Depth
 * On top of maintaining session information (contained in the launchSession property),
 * WebAppSession provides access to a number of capabilities. - MediaPlayer -
 * MediaControl - Bi-directional communication with web app
 * <p>
...
public class WebAppSession implements MediaControl, MediaPlayer, PlaylistControl {
     ...
     *
     * @param connectionListener callback
     */
     ...
     * etc.
     */
    public interface LaunchListener extends
