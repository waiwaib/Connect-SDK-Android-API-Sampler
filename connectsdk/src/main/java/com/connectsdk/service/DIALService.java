...
public class DIALService extends DeviceService implements Launcher {
    ...
    public void launchAppWithInfo(final AppInfo appInfo, Object params, final AppLaunchListener listener) {
        ServiceCommand command =
            ...
            public void onSuccess(Object any) {
                ...
                launchSession.setSessionId((String) any);
    ...
    public void closeApp(final LaunchSession launchSession, final ResponseListener<Object> listener) {
        getAppState(launchSession.getAppName(), new AppStateListener() {
            ...
            @Override
            public void onSuccess(AppState any) {
                String uri;
                ...
                ServiceCommand command =
                        new ServiceCommand(launchSession.getService(),
                                uri, null, listener);
...
//                        listener.onAppStateSuccess(state);
        ...
        ServiceCommand request =
                new ServiceCommand(getCommandProcessor(), uri, null,
                        responseListener);
    ...
    public void sendCommand(final ServiceCommand mCommand) {
        Util.runInBackground(() -> {
            ...
            try {
                ...
                } else if (mCommand.getHttpMethod().equalsIgnoreCase(ServiceCommand.TYPE_DEL)) {
                ...
                if (code == 200) {
                    ...
                    Util.postSuccess(mCommand.getResponseListener(), connection.getResponseHeader("Location"));
                } else {
    ...
    private void hasApplication(String appID, ResponseListener<Object> listener) {
        ...
        ServiceCommand command =
                new ServiceCommand(getCommandProcessor(), uri, null, listener);
