...
public class ServiceDescription implements Cloneable {
    ...
    public ServiceDescription clone()  {
        ...
        try {
            service = (ServiceDescription) super.clone();
        ...
        try { service.setServiceID(this.serviceID); } catch (NullPointerException ignored) { }
        try { service.setIpAddress(this.ipAddress); } catch (NullPointerException ignored) { }
        try { service.setUUID(this.UUID); } catch (NullPointerException ignored) { }
        try { service.setVersion(this.version); } catch (NullPointerException ignored) { }
        try { service.setFriendlyName(this.friendlyName); } catch (NullPointerException ignored) { }
        try { service.setManufacturer(this.manufacturer); } catch (NullPointerException ignored) { }
        try { service.setModelName(this.modelName); } catch (NullPointerException ignored) { }
        try { service.setModelNumber(this.modelNumber); } catch (NullPointerException ignored) { }
        try { service.setModelDescription(this.modelDescription); } catch (NullPointerException ignored) { }
        try { service.setApplicationURL(this.applicationURL); } catch (NullPointerException ignored) { }
        try { service.setLocationXML(this.locationXML); } catch (NullPointerException ignored) { }
        try { service.setResponseHeaders(this.responseHeaders); } catch (NullPointerException ignored) { }
        try { service.setServiceList(this.serviceList); } catch (NullPointerException ignored) { }
        try { service.setServiceFilter(this.serviceFilter); } catch (NullPointerException ignored) { }
