...
public interface ExternalInputControl extends CapabilityMethods {
     ...
     * <p>
     * Passes a list containing an ExternalInputInfo object for each available external
     * input on the device
     */
    interface ExternalInputListListener extends ResponseListener<List<ExternalInputInfo>> {
    }
}