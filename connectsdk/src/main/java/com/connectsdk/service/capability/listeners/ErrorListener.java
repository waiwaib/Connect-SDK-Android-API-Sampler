 ...
 * ServiceCommandError object. Connect SDK will make all attempts to give you the lowest-level
 * error possible. In cases where an error is generated by Connect SDK, an enumerated error code
 ...
 * ####Result
 * <p>
 * Connect SDK will call the ErrorListener and pass off the ServiceCommandError generated during
 * parsing of the XML.
 * <p>
 ...
 * ####Result
 * <p>
 * The capability method will immediately invoke the ErrorListener and pass off an
 * ServiceCommandError object with a status code of ConnectStatusCodeArgumentError.
 * <p>
 * ServiceCommandError object describing the nature of the problem. Error descriptions are not
