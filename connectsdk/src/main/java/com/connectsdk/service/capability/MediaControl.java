...
public interface MediaControl extends CapabilityMethods {
    ...
    /**
     * Success block that is called upon successfully getting the media file's current play head position.
     * <p>
     * Passes the position of the current play head position of the current media file, in seconds
     */
