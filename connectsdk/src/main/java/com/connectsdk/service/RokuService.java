...
/** @noinspection CharsetObjectCanBeUsed, unused */
public class RokuService extends DeviceService implements Launcher, MediaPlayer, MediaControl, KeyControl, TextInputControl {
    ...
    public static final String TAG = "RokuService";
    ...
    public void launchAppWithInfo(final AppInfo appInfo, Object params,
        ...
        ServiceCommand request = getServiceCommand(appInfo, listener, targetURL);
        request.send();
    }

    @NonNull
    private ServiceCommand getServiceCommand(AppInfo appInfo, AppLaunchListener listener, String targetURL) {
        ...
        return new ServiceCommand(this, targetURL, null, responseListener);
    }
    ...
    public void stop(ResponseListener<Object> listener) {
        ...
        String uri = requestURL(null, param);
        ServiceCommand request = new ServiceCommand(this, uri, null, listener);
        request.send();
    }
    ...
    public void sendText(String input) {
        ...
        Log.d(this.getClass().getSimpleName(), "RokuService::send() | uri = " + uri);
    ...
    public void sendCommand(final ServiceCommand mCommand) {
        Util.runInBackground(() -> {
            ...
            try {
                Log.d(TAG, "RESP " + mCommand.getTarget());
                HttpConnection connection = HttpConnection.newInstance(URI.create(mCommand.getTarget()));
                if (mCommand.getHttpMethod().equalsIgnoreCase(ServiceCommand.TYPE_POST)) {
