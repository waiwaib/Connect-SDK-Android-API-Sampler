...
public class WebOSTVDeviceService extends DeviceService implements PowerControl, MediaControl {
    ...
    public interface WebOSTVServicePermission {
        ...
        enum Protected implements WebOSTVServicePermission {
         ...
         WebOSTVServicePermission[] PROTECTED = {
        ...
        WebOSTVServicePermission[] PERSONAL_ACTIVITY = {
    ...
    public ServiceCommand getCurrentSWInfo(final ResponseListener<Object> listener) {
    ...
    protected ServiceCommand getMuteStatus(boolean isSubscription, final VolumeControl.MuteListener listener) {
        ServiceCommand request;
    ...
    protected ServiceCommand getVolumeStatus(boolean isSubscription, final VolumeControl.VolumeStatusListener listener) {
        ServiceCommand request;
    ...
    protected ServiceCommand getCurrentChannel(boolean isSubscription, final TVControl.ChannelListener listener) {
        ServiceCommand request;
    ...
    protected ServiceCommand getChannelList(boolean isSubscription, final TVControl.ChannelListListener listener) {
        ServiceCommand request;
    ...
    protected ServiceCommand getChannelCurrentProgramInfo(boolean isSubscription, final TVControl.ProgramInfoListener listener) {
    ...
    protected ServiceCommand getProgramList(boolean isSubscription, final TVControl.ProgramListListener listener) {
        ServiceCommand request;
    ...
    protected ServiceCommand getRunningApp(boolean isSubscription, final Launcher.AppInfoListener listener) {
        ServiceCommand request;
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onSuccess(Object any) {
                final JSONObject jsonObj = (JSONObject) any;
    ...
    protected ServiceCommand getAppState(boolean subscription, LaunchSession launchSession, final Launcher.AppStateListener listener) {
        ServiceCommand request;
...
//            params.put("appId", launchSession.getAppId());
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onSuccess(Object any) {
                JSONObject json = (JSONObject) any;
                try {
    ...
    protected ServiceCommand getVolume(boolean isSubscription, final VolumeControl.VolumeListener listener) {
        ServiceCommand request;
