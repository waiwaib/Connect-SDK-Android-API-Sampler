...
public class VizioService extends DeviceService {
    public static final String ID = "VizioService";

    public VizioService(ServiceDescription serviceDescription, ServiceConfig serviceConf) {
        super(serviceDescription, serviceConf);
        pairingType = PairingType.PIN_CODE;
    }

    public static DiscoveryFilter discoveryFilter() {
        return new DiscoveryFilter(ID, "_viziocast._tcp.");
    }
