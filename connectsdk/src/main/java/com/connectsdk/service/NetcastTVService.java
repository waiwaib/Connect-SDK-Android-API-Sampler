...
public class NetcastTVService extends DeviceService implements Launcher, MediaControl, MediaPlayer, TVControl, VolumeControl, ExternalInputControl, MouseControl, TextInputControl, PowerControl, KeyControl {
    ...
    public static final String TAG = "NetcastTVService";
    ...
    public void connect() {
        ...
        if (DiscoveryManager.getInstance().getPairingLevel() == PairingLevel.ON) {
            if (((NetcastTVServiceConfig) serviceConfig).getPairingKey() != null 
                    && !((NetcastTVServiceConfig) serviceConfig).getPairingKey().isEmpty()) {
...
//        mServiceReachability.start();
    ...
    public void showPairingKeyOnTV() {
        ...
        ServiceCommand command = new ServiceCommand(this, requestURL, httpMessage, responseListener);
        command.send();
    }
    ...
    private void endPairing() {
        ...
        ServiceCommand command = new ServiceCommand(this, requestURL, httpMessage, null);
        command.send();
    }
    ...
    public void getApplication(final String appName, final AppInfoListener listener) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onSuccess(Object any) {
                final String strObj = (String) any;
        ...
        ServiceCommand command = new ServiceCommand(this, requestURL, null, responseListener);
    ...
    public void launchApp(final String appId, final AppLaunchListener listener) {
        getAppInfoForId(appId, new AppInfoListener() {
            ...
            @Override
            public void onSuccess(AppInfo any) {
                launchAppWithInfo(any, listener);
            }
        });
    }
    ...
    private void getAppInfoForId(final String appId, final AppInfoListener listener) {
        getAppList(new AppListListener() {
            ...
            @Override
            public void onSuccess(List<AppInfo> any) {
                for (AppInfo info : any) {
    ...
    private void launchApplication(final String appName, final String auid, final String contentId, final AppLaunchListener listener) {
        ...
        ServiceCommand request = new ServiceCommand(this, requestURL, httpMessage, responseListener);
        request.send();
    }
    ...
    public void launchBrowser(String url, final AppLaunchListener listener) {
        if (!(url == null || url.isEmpty()))
            Log.d(Util.T, "Netcast TV does not support deeplink for Browser");
        ...
        getApplication(appName, new AppInfoListener() {
            ...
            @Override
            public void onSuccess(AppInfo any) {
                launchApplication(appName, any.getId(), null, listener);
            }
    ...
    public void launchYouTube(final String contentId, float startTime, final AppLaunchListener listener) {
        ...
        if (startTime <= 0.0) {
            getApplication("YouTube", new AppInfoListener() {
                ...
                @Override
                public void onSuccess(AppInfo any) {
                    launchApplication(any.getName(), any.getId(), contentId, listener);
                }
    ...
    public void launchHulu(final String contentId, final AppLaunchListener listener) {
        ...
        getApplication(appName, new AppInfoListener() {
            ...
            @Override
            public void onSuccess(AppInfo any) {
                launchApplication(appName, any.getId(), contentId, listener);
            }
    ...
    public void launchNetflix(final String contentId, final AppLaunchListener listener) {
        ...
        getApplication(appName, new AppInfoListener() {
            ...
            public void onSuccess(final AppInfo appInfo) {
                ...
                Map<String, String> params = getParams(contentId);
    ...
    @NonNull
    private static Map<String, String> getParams(String contentId) {
        Map <String,String> params = new HashMap<>();
        ...
        params.put("item_id", "-Q m=http%3A%2F%2Fapi.netflix.com%2Fcatalog%2Ftitles%2Fmovies%2F"
                + contentId + "&amp;source_type=4&amp;trackId=6054700&amp;trackUrl=https%3A%2F%2Fapi.netflix.com%2FAPI_APP_ID_6261%3F%23Search%3F");
        params.put("app_type", "");
        return params;
    }
    ...
    public void launchAppStore(final String appId, final AppLaunchListener listener) {
        if (!serviceDescription.getModelNumber().equals("4.0")) {
            // FIXME: this will not work in Korea, use Korean name instead
    ...
    public void closeApp(LaunchSession launchSession, ResponseListener<Object> listener) {
        ...
        ServiceCommand command = new ServiceCommand(launchSession.getService(), requestURL, httpMessage, listener);
        command.send();
    }
    ...
    private void getApplications(int type, int number, final AppListListener listener) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            public void onSuccess(Object any) {
                ...
                for (int i = 0; i < Objects.requireNonNull(applicationArray).length(); i++)
                {
                    try {
    ...
    public void getAppList(final AppListListener listener) {
        ...
        getTotalNumberOfApplications(2, new AppCountListener() {
            ...
            @Override
            public void onSuccess(final Integer any) {
                getApplications(2, any, new AppListListener() {

                    @Override
                    public void onSuccess(List<AppInfo> any) {
                        applications.addAll(any);

                        getTotalNumberOfApplications(3, new AppCountListener() {

                            @Override
                            public void onSuccess(final Integer any) {
                                getApplications(3, any, new AppListListener() {
    ...
    public void getChannelList(final ChannelListListener listener) {
        ...
        ServiceCommand request = new ServiceCommand(this, requestURL, null, responseListener);
    ...
    public void setChannel(final ChannelInfo channelInfo, final ResponseListener<Object> listener) {
        getChannelList(new ChannelListListener() {
            ...
            @Override
            public void onSuccess(List<ChannelInfo> any) {
                String requestURL = getUDAPRequestURL(UDAP_PATH_COMMAND);

                Map<String, String> params = new HashMap<>();

                for (int i = 0; i < any.size(); i++) {
                    ChannelInfo ch = any.get(i);
                ...
                ServiceCommand request = new ServiceCommand(NetcastTVService.this, requestURL, httpMessage, listener);
                request.send();
            }
    ...
    public void getVolume(final VolumeListener listener) {
        ...
        getVolumeStatus(new VolumeStatusListener() {
            ...
            @Override
            public void onSuccess(VolumeStatus any) {
                Util.postSuccess(listener, any.volume);
            }
    ...
    public void getMute(final MuteListener listener) {
        ...
        getVolumeStatus(new VolumeStatusListener() {
            ...
            @Override
            public void onSuccess(VolumeStatus any) {
                Util.postSuccess(listener, any.isMute);
            }
    ...
    public void launchInputPicker(final AppLaunchListener listener) {
        ...
        getApplication(encodedStr, new AppInfoListener() {
            ...
            @Override
            public void onSuccess(final AppInfo any) {
                AppLaunchListener launchListener = new AppLaunchListener() {

                    @Override
                    public void onSuccess(LaunchSession any) {
                        if (inputPickerSession == null) {
                            inputPickerSession = any;
                        }

                        Util.postSuccess(listener, any);
                    }
                ...
                launchApplication(appName, any.getId(), null, launchListener);
            }
    ...
    public void displayImage(final String url, final String mimeType, final String title, final String description, final String iconSrc, final LaunchListener listener) {
        if (getDLNAService() != null) {
            final LaunchListener launchListener = new LaunchListener() {
                ...
                @Override
                public void onSuccess(MediaLaunchObject any) {
                    any.launchSession.setAppId(SMART_SHARE);
                    any.launchSession.setAppName(SMART_SHARE);

                    any.mediaControl = NetcastTVService.this.getMediaControl();
    ...
    public void connectMouse() {
        ResponseListener<Object> listener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                Log.d(Util.T, "Netcast TV's mouse connection has been failed");
            }
        };
    ...
    public void click() {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                Log.d(Util.T, "Netcast TV's mouse click has been failed");
            }
        };
    ...
    private void moveMouse() {
        ...
        ResponseListener<Object> responseListener = getResponseListener();
    ...
    @NonNull
    private ResponseListener<Object> getResponseListener() {
        ...
        return new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                Log.d(Util.T, "Netcast TV's mouse move has failed");
    ...
    public void scroll(double dx, double dy) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                Log.d(Util.T, "Netcast TV's mouse scroll has been failed");
            }
        };
    ...
    public void sendEnter() {
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                Log.d(Util.T, "Netcast TV's enter key has been failed");
            }
        };
    ...
    private final ResponseListener<String> mTextChangedListener = new ResponseListener<String>() {

        @Override
        public void onError(ServiceCommandError error) { }

        @Override
        public void onSuccess(String any) {
            keyboardString = new StringBuilder(any);
        }
    };
    ...
    private void handleKeyboardInput(final String state, final String buffer) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                Log.d(Util.T, "Netcast TV's keyboard input has been failed");
            }
        };
    ...
    public void powerOff(ResponseListener<Object> listener) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                Log.d(Util.T, "Netcast TV's power off has been failed");
            }
        };
    ...
    public void sendCommand(final ServiceCommand mCommand) {
        Util.runInBackground(() -> {
            ...
            try {
                ...
                if (payload != null && mCommand.getHttpMethod().equalsIgnoreCase(ServiceCommand.TYPE_POST)) {
                ...
                Log.d(TAG, "RESP " + code);
                if (code == 200) {
                    Util.postSuccess(mCommand.getResponseListener(), connection.getResponseString());
                } else {
                    Util.postError(mCommand.getResponseListener(), ServiceCommandError.getError(code));
                }
            } catch (IOException e) {
                Log.e(Util.T, "error",e);
                Util.postError(mCommand.getResponseListener(), new ServiceCommandError(0, e.getMessage(), null));
            }
        });
    }
