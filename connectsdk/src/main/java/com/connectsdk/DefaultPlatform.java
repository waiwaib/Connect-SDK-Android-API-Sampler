...
public class DefaultPlatform {
    ...
    public static HashMap<String, String> getDeviceServiceMap() {
        ...
        devicesList.put("com.connectsdk.service.AndroidTVService", "com.connectsdk.discovery.provider.ZeroconfDiscoveryProvider");
        devicesList.put("com.connectsdk.service.FireTVmDNSService", "com.connectsdk.discovery.provider.ZeroconfDiscoveryProvider");
        devicesList.put("com.connectsdk.service.PhillipsService", "com.connectsdk.discovery.provider.ZeroconfDiscoveryProvider");
